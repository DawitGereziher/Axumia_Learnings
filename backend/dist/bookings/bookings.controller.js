...
let BookingsController = class BookingsController {
    ...
    requestBooking(slotId, user, body) {
        return this.bookings.requestBooking(user.id, slotId, body?.session_type || '1-on-1', body?.notes);
    }
    myBookings(user) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get available slots for an instructor' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: '[Student] Request a booking slot' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: '[Instructor] Create availability slot' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
