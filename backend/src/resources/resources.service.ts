...
export class ResourcesService {
  ...
  async incrementDownload(id: string) {
    ...
    if (!resource || !resource.is_active) return null;
  ...
  async seed() {
    // Seed demo resources if table is empty
    ...
    const items = [
      ...
      },
      {
        ...
        description:
          'Essential vocabulary and phrases for Afaan Oromoo beginners',
        category: 'oromiffa',
        file_url: '#',
        file_size: 1800000,
        file_type: 'pdf',
      ...
      },
      {
        ...
        description:
          'Official-style SAT Math practice with answer explanations',
        category: 'sat',
        file_url: '#',
        file_size: 2900000,
        file_type: 'pdf',
      ...
      },
      {
        ...
        description:
          'Concise physics notes covering the full national curriculum',
        category: 'grade12',
        file_url: '#',
        file_size: 3800000,
        file_type: 'pdf',
      ...
      },
      {
        ...
        description:
          'Step-by-step guide to becoming a fullstack developer, in Amharic',
        category: 'it',
        file_url: '#',
        file_size: 1200000,
        file_type: 'pdf',
      ...
      },
      {
        ...
        description:
          'High-frequency SAT vocabulary with definitions and examples',
        category: 'sat',
        file_url: '#',
        file_size: 750000,
        file_type: 'pdf',
